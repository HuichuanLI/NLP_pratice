...
trainer = BertFCTrainer(
    pretrained_model_dir='./model/chinese-roberta-wwm-ext', model_dir='./tmp/bertfc', learning_rate=5e-5,
...
predictor = BertFCPredictor(
    pretrained_model_dir='./model/chinese-roberta-wwm-ext', model_dir='./tmp/bertfc',
    enable_parallel=True
)
